...
class fragment_main : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buContact.setOnClickListener{
            view.findNavController().navigate(R.id.action_fragment_main_to_contact_fragment)
        }
        buAbout.setOnClickListener {
         view.findNavController().navigate(R.id.action_fragment_main_to_about_fragment)
        }
    }
}